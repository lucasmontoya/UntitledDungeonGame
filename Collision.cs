...
namespace DungeonGame
{
    class Collision
    {
        ...
        public bool checkHeroWall(Attributes hero, IList<IList<Obstacles>> walls, int borderX, int borderY)
        {
            ...
            {
                if (hero.X.Equals(i) && hero.Y.Equals(5)) // I don't like hardcoding 5
                    return true;
            }
            ...
            for (int i = 0; i < (borderX + 5); i++)
            {
                if (hero.X.Equals(i) && hero.Y.Equals(borderY + 4)) // I don't like hardcoding 4.
                    return true;
            }
            ...
            {
                if (hero.X.Equals(5) && hero.Y.Equals(i)) // I don't like hardcoding 5.
                    return true;
            }
            ...
            for (int i = 0; i < (borderY + 5); i++)
            {
                if (hero.X.Equals(borderX + 5) && hero.Y.Equals(i)) // I don't like hardcoding 5.
                    return true;
            }
            return false;
        }
